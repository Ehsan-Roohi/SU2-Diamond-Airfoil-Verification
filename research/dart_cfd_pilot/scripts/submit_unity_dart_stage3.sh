...
#SBATCH --output=logs/dart-cfd-s3-%j.out
#SBATCH --error=logs/dart-cfd-s3-%j.err
...
readonly RUN_ID="${SLURM_JOB_ID:-stage3-manual}"
...
echo "DART_STAGE3_RC=${run_rc}"
echo "DART_STAGE3_OUTPUT_DIR=${OUTPUT_DIR}"
echo "DART_STAGE3_ARCHIVE=${ARCHIVE}"
echo "DART_STAGE3_CHECKSUM=${CHECKSUM}"
exit "${run_rc}"
