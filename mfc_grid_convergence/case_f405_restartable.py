#!/usr/bin/env python3
"""Restartable f405 MFC Mach-3/AoA-40 diamond-airfoil case.

The three production segments use one case definition.  Segment 1 creates the
...
parser.add_argument("--stop-step", type=int, default=109350)
...
# f180/f270/f405 use a constant refinement ratio of 1.5.  MFC stores the
# maximum zero-based indices, hence 4455 x 4050 cells are m=4454, n=4049.
m = 4454
n = 4049
x_beg, x_end = -5.0, 6.0
y_beg, y_end = -5.0, 5.0
...
case = {
    "run_time_info": "T",
    # MFC 0c9a1d43's validator requires the original bounds even with old_grid.
    "x_domain%beg": x_beg,
    "x_domain%end": x_end,
    "y_domain%beg": y_beg,
    "y_domain%end": y_end,
