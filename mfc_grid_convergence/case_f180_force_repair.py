#!/usr/bin/env python3
"""Clean f180 force-repair run for the MFC Mach-3/AoA-40 grid study."""
...
parser.add_argument("--steps", type=int, default=48600)
parser.add_argument("--save-every", type=int, default=1944)
...
# This is the coarse member of the exact 180/270/405 cells-per-chord family.
# The common physical output cadence is Delta(t)=0.54 and t_stop=13.5.
m = 1979
n = 1799
x_beg, x_end = -5.0, 6.0
y_beg, y_end = -5.0, 5.0
