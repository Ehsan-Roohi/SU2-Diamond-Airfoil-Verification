#!/usr/bin/env python3
"""Short, high-cadence Mach-3/AoA-40 startup run for MFC's 2-D IBM."""
...
parser.add_argument("--steps", type=int, default=4320)
...
# Same physical domain, grid, time step, numerics, and planar STL used by the
# completed f270 run. With the defaults: dt=1/5400, t_stop=0.8 and
# Delta(t_save)=0.02 (41 states including t=0).
m = 2969
n = 2699
x_beg, x_end = -5.0, 6.0
y_beg, y_end = -5.0, 5.0
